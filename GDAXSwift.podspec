Pod::Spec.new do |s|
  s.name             = 'GDAXSwift'
  s.version          = '0.1.2'
  s.summary          = 'Unofficial Swift wrapper around the GDAX API'
  s.description      = 'Unofficial Swift wrapper around the GDAX API to allow easy programmatic trading and data querying'
